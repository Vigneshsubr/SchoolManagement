...
public class ResultService {
	...
	public ResponseDTO displayResult(Long studentId) {
		return ResponseDTO.builder().message(Constants.RETRIEVED).data(resultRepository.findByStudentId(studentId))
	...
	public ResponseDTO calculateTotalMarks(Long studentId) {
		return ResponseDTO.builder().message(Constants.FOUND)
				.data(resultRepository.calculateTotalByStudentId(studentId)).statusCode(200).build();
	}
